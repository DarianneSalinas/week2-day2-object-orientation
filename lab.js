...
favoriteThings.car = 'Pontiac'
favoriteThings.show = 'Mad men'
...
favoriteThings.food = 'Chicken Nuggests';
...
const {color: carColorName} = carDetails
const {make: carMakeName} = carDetails
const {model: carModelName} = carDetails
const {year: carYear} = carDetails
console.log(carColorName)
...
// const {firstName: myFirstName} = greeting
...
//we're writing a function but not seeing the object
//if we want to see it in action, here is the code, but not required in the prompt
...
user.email = 'bryabn.smith@devmountain.in';
...
const kittie = new Cat ('Elmer','3', 'black')
...
/*
  ...
  Add a function to your Wizard class called castSpell. This function should print "{name} has 
  cast {favoriteSpell}"
...
const wizardHermione = new Wizard('Hermione', 16, 'Expelliarmus')
console.log(wizardHermione.favoriteSpell)
//////////////////////////// PROBLEM 14 ////////////////////////////
/*
    ...
    sell should be a function that changes the value of sold 
    to true and prints the string: '{brand} {model} has been sold.'
...
class Phone {
  ...
  const soldIphone = new Phone('Apple', '13', '256gb', 'white', '900');
  soldIphone.changePrice("800");
  console.log(soldIphone)
...
const cellPhone1 = new Phone('Apple', '6s', '64gb', 'black', '350' );
const cellPhone2 = new Phone('Apple', '11', '164gb', 'blue', '855' );
const cellPhone3 = new Phone('Apple', '13Pro', '164gb', 'red', '1100' );
/* 
